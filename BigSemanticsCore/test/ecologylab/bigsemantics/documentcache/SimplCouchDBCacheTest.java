...
/** 
 * JUnit test for the SimplCouchDBCache class.
 * TODO Tests are non-functional as setUp() has not been revised to utilize factory constructor
 * 
 * @author colton
 *
 */
public class SimplCouchDBCacheTest
{
	private SimplCouchDBCache cache;
	
	@Before
	public void setUp() throws Exception
	{
		cache = SimplCouchDBCache.simplCouchDBCacheFactory(null);
	}
